...
file:File;
        ...
        resolve(
          //img ,id ,cat id
           this.userserv.getListObject(2,this.imageBase64).then(data => {
             ...
             this.spinner=false;
            debugger;
             document.getElementById("image").setAttribute("style","margin-top: -6%;max-width:55%;border: 2px;border-radius: 20%;margin-left: 23%;border:solid;border-width: 3px");
             this.viewlist=true;
          ...
          //list Save imageBase64
           this.userserv.postListObject(2,this.imageBase64,this.listsave).then(data => {
            ...
            if(data!=false)
              ...
              this.notsaved=true;
            this.spinner=false;
            document.getElementById("image").setAttribute("style","margin-left:23%;max-width: 55%;border: 2px;border-radius: 20%;border:solid;border-width: 5px;margin-top: -6%;");
            debugger;
            this.picturetaken=false;
            console.log(this.listObj);
           })
  ...
  async sendToVision() {
    debugger;
   this.listFull=false;
    document.getElementById("image").setAttribute("style","max-width: 55%;border: 2px;border-radius: 20%;margin-left:23%;border:solid;border-width: 3px;opacity:0.4;margin-top:-6%;");
    this.listObj=[];
    this.spinner=true;
 ...
 imageBase64;
  ...
  //send objectlist to server and update in db
    saveInDB(){
      ...
      document.getElementById("image").setAttribute("style","margin-left:23%;max-width:55%;border: 2px;border-radius: 20%;opacity:0.4 ;border:solid;border-width: 5px;margin-top: -6%;");
...
makeTransparency(event,obj:imageObject){
  ...
  this.valuetext="";
  this.sendtodb=false;
  document.getElementById("image").setAttribute("style","max-width:55%;border: 2px;border-radius: 20%;margin-left:23%;border:solid;border-width: 3px;margin-top: -6%;");
  debugger;
  this.showradio=true;
///
