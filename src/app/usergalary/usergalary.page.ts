  ...
  resolveAfter4SecondsGetlist() {
    return new Promise(resolve => {
      setTimeout(() => {
        resolve(
          //img ,id ,cat id
           this.userserv.getListObject(12,this.myimage).then(data => {
             this.listObj = data;
            debugger;
