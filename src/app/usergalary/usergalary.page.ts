  ...
  resolveAfter4SecondsGetlist() {
    return new Promise(resolve => {
      setTimeout(() => {
        resolve(
          //img ,id ,cat id
           this.userserv.getListObject(12,this.image).then(data => {
             this.listObj = data;
            debugger;
  ...
  resolveAfter4SecondsPostlist(){
    return new Promise(resolve => {
      setTimeout(() => {
        resolve(
          //list Save
           this.userserv.getListObject(13,this.myimage).then(data => {
            this.listObj = data;
           debugger;
             console.log(this.listObj);
           })
